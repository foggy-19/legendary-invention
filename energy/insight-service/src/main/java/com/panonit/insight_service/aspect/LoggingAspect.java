package com.panonit.insight_service.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.panonit.insight_service.controller.*.*(..))")
    public void controllerMethods() {
    }

    @Pointcut("execution(* com.panonit.insight_service.service.*.*(..))")
